                ...
                <div class="panel-body">
                    <form method="post" action="" class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="rps" class="form-control" placeholder="Enter Reponse" value="<?php echo !empty($dossier['REPONSE'])?$dossier['REPONSE']:''; ?>">
                            <?php echo form_error('rps','<p class="text-danger">','</p>'); ?>
                        </div>

                        <div class="form-group">
                            <label for="etat">Etat Dossier</label>
                            <input name="etat" class="form-control" placeholder="Enter etat" value="<?php echo !empty($dossier['ETAT_DOSSIER'])?$dossier['ETAT_DOSSIER']:''; ?>">
